...
|---------------|---------------------|-----------------------------|
| 2.x           | 3.3.0-boot2         | 3.3.0-boot2                 |
| 3.x           | 3.3.0-boot3         | 3.3.0-boot3                 |

> 注意，3.3.0-boot2版本的Graceful
> Response源码由单独的仓库进行维护，地址为：https://github.com/feiniaojin/graceful-response-boot2

> 3.3.0-boot2和3.3.0-boot3除了支持的SpringBoot版本不一样，其他实现完全一致，Maven引用时只需要根据对应的SpringBoot版本选择Graceful
